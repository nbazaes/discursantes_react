  ...
  es: {
    translation: {
      ...
      dashboard: {
        ...
        tasksTitle: 'Tablero de Coordinación',
        tasksDesc: 'Seguimiento de tareas y coordinación del obispado',
      },
      speakersPage: {
        title: 'Discursantes',
      ...
      sundayPage: {
        ...
        neverTag: '(nunca)',
        agoDays_one: 'hace {{count}} día',
        agoDays_other: 'hace {{count}} días',
      ...
      kanban: {
        ...
        subtitle: 'Seguimiento de tareas del obispado',
        boardTitle: 'Tablero de tareas',
        newTask: 'Nueva Tarea',
        colPendiente: 'Pendiente',
        colAsignado: 'Asignado',
        colEnProgreso: 'En progreso',
        ...
        addFirst: 'Crear la primera tarea',
        deleteConfirm: 'Eliminar la tarea "{{title}}"?',
        saveError: 'Error al guardar: {{error}}',
        deleteError: 'Error al eliminar',
        moveLeft: 'Mover a {{column}}',
        moveRight: 'Mover a {{column}}',
        dragHandle: 'Arrastrar tarea',
  ...
  en: {
    translation: {
      ...
      dashboard: {
        ...
        tasksTitle: 'Coordination Board',
        tasksDesc: 'Track bishopric tasks and coordination',
      },
      speakersPage: {
        title: 'Speakers',
      ...
      sundayPage: {
        ...
        neverTag: '(never)',
        agoDays_one: '{{count}} day ago',
        agoDays_other: '{{count}} days ago',
      ...
      kanban: {
        ...
        subtitle: 'Bishopric task tracking',
        boardTitle: 'Task board',
        newTask: 'New Task',
        colPendiente: 'Pending',
        colAsignado: 'Assigned',
        colEnProgreso: 'In progress',
        ...
        addFirst: 'Create the first task',
        deleteConfirm: 'Delete task "{{title}}"?',
        saveError: 'Error saving: {{error}}',
        deleteError: 'Error deleting',
        moveLeft: 'Move to {{column}}',
        moveRight: 'Move to {{column}}',
        dragHandle: 'Drag task',
